...
async def start_handler(
    ...
    if not user_in_db:
        ...
        await message.reply(
            "<u><b>ملاحظة:</b></u>\n\n"
            "إذا كنت مستخدماً قديماً للبوت ورأيت هذه الرسالة لا داعي للقلق بياناتك ما زالت لدينا، "
            "كل ما عليك فعله هو إرسال رسالة للفريق عن طريق البوت تخبرهم <b><u>برقمك التسلسي القديم</u></b> "
            "وسيتم مواصلة مقابلاتك وخطتك العلاجية كما كانت 😇.\n\n"
            f"<b><u>لكن من الآن فصاعداً رقمك التسلسي هو: {user_serial}.</b></u>\n\n"
            "إذا كنت مستخدماً جديداً يمكنك تجاهل هذه الرسالة."
        )
        return
